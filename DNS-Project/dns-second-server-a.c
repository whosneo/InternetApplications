...
//Second DNS Server A  -->>  127.4.4.1  a.second-servers.net

#define DNS_SERVER_ADDRESS                      DNS_SERVER_5
#define DNS_FILE                                "dns-second-server-a.txt"
#define DNS_FILE_CACHE                          "dns-second-server-a-cache.txt"
