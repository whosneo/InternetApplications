...
//Root DNS Server  -->>  127.2.2.1  root-servers.net

#define DNS_SERVER_ADDRESS                      DNS_SERVER_1
#define DNS_FILE                                "dns-root-server.txt"
#define DNS_FILE_CACHE                          "dns-root-server-cache.txt"
