...
//Second DNS Server B  -->>  127.4.4.2  b.second-servers.net

#define DNS_SERVER_ADDRESS                      DNS_SERVER_6
#define DNS_FILE                                "dns-second-server-b.txt"
#define DNS_FILE_CACHE                          "dns-second-server-b-cache.txt"
