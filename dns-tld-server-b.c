...
//TLD DNS Server B  -->>  127.3.3.2  b.tld-servers.net

#define DNS_SERVER_ADDRESS                      DNS_SERVER_4
#define DNS_FILE                                "dns-tld-server-b.txt"
#define DNS_FILE_CACHE                          "dns-tld-server-b-cache.txt"
